	...
	public static class ZetAspectBarrier
	{
		...
		public static void SetupTokens()
		{
			...
			foreach (string language in fragments.Keys)
			{
				...
				EquipmentDef equipDef = EquipDefOf.AffixBarrier;
				if (equipDef)
				{
	...
	public static class ZetAspectBlackHole
	{
		...
		public static void SetupTokens()
		{
			...
			foreach (string language in fragments.Keys)
			{
				...
				EquipmentDef equipDef = EquipDefOf.AffixBlackHole;
				if (equipDef)
				{
					RegisterToken(equipDef.nameToken, TextFragment("AFFIX_" + affix + "_NAME"));
					RegisterToken(equipDef.pickupToken, TextFragment("AFFIX_" + affix + "_PICKUP"));
	...
	public static class ZetAspectMoney
	{
		...
		public static void SetupTokens()
		{
			...
			foreach (string language in fragments.Keys)
			{
				...
				EquipmentDef equipDef = EquipDefOf.AffixMoney;
				if (equipDef)
				{
					RegisterToken(equipDef.nameToken, TextFragment("AFFIX_" + affix + "_NAME"));
					RegisterToken(equipDef.pickupToken, TextFragment("AFFIX_" + affix + "_PICKUP"));
	...
	public static class ZetAspectNight
	{
		...
		public static void SetupTokens()
		{
			...
			foreach (string language in fragments.Keys)
			{
				...
				EquipmentDef equipDef = EquipDefOf.AffixNight;
				if (equipDef)
				{
					RegisterToken(equipDef.nameToken, TextFragment("AFFIX_" + affix + "_NAME"));
					RegisterToken(equipDef.pickupToken, TextFragment("AFFIX_" + affix + "_PICKUP"));
	...
	public static class ZetAspectWater
	{
		...
		public static void SetupTokens()
		{
			...
			foreach (string language in fragments.Keys)
			{
				...
				EquipmentDef equipDef = EquipDefOf.AffixWater;
				if (equipDef)
				{
					RegisterToken(equipDef.nameToken, TextFragment("AFFIX_" + affix + "_NAME"));
					RegisterToken(equipDef.pickupToken, TextFragment("AFFIX_" + affix + "_PICKUP"));
	...
	public static class ZetAspectRealgar
	{
		...
		public static void SetupTokens()
		{
			...
			foreach (string language in fragments.Keys)
			{
				...
				EquipmentDef equipDef = EquipDefOf.AffixRealgar;
				if (equipDef)
				{
					RegisterToken(equipDef.nameToken, TextFragment("AFFIX_" + affix + "_NAME"));
					RegisterToken(equipDef.pickupToken, TextFragment("AFFIX_" + affix + "_PICKUP"));
